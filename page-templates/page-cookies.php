 ...
 */
get_header(); ?>
<section class="wrapper cookies">
    <div class="container">
      <main id="main" class="site-main" role="main">
      <?php while ( have_posts() ) : the_post();?>
	  	<h1><?php the_title();?></h1>
	  <?php endwhile; // end of the loop. ?>
      <p>[COMPANY NAME] is committed to protecting your privacy. We value our visitors and endeavour to create an enjoyable and safe shopping experience when visiting our website.</p>
<p>Reg no: [REG NUMBER], Registered in England &amp; Wales.</p>
...
<ul class="list1">
<li><a href="#pp_one">Information collected by our website</a></li>
<li><a href="#pp_two">Controlling your personal information</a></li>
<li><a href="#pp_three">Website Security</a></li>
<li><a href="#pp_four">An Introduction to cookies</a></li>
<li><a href="#pp_five">Your consent for cookie deployment by our website.</a></li>
<li><a href="#pp_six">Cookies used by our website</a></li>
<li><a href="#pp_seven">Actual cookies deployed</a></li>
<li><a href="#pp_eight">How to disable cookies</a></li>
</ul>
<h2><a id="pp_one"></a>Information collected by our website</h2>
<ul>
<li>
<h3>What we collect</h3>
<p>For the purpose of making an enquiring or placing an order, our website may collect the following information. Your name and appropriate contact information including email address, address, preferences and interests. Other information relevant to customer surveys and/or offers may also be requested.</li>
<li>
...
<h2><a id="pp_two"></a>Controlling your personal information</h2>
...
<h2><a id="pp_three"></a>Security</h2>
<ul>
<li>
<h3>Website Security</h3>
<p>We are committed to ensuring that your information is secure. In order to prevent unauthorised access or disclosure, we have put in place suitable physical, electronic and managerial procedures to safeguard and secure the information we collect online.</li>
<li>
...
<h2><a id="pp_four"></a>An introduction to cookies</h2>
...
<p>The majority of modern web browsers will automatically allow cookies to be placed onto your device. However you can usually modify your browser&#8217;s settings in order to prevent any cookies from being placed onto your device. Setting your browser to block cookies may prevent you from taking full advantage of our website.</p>
...
<li>
<h3>Enquiry Forms</h3>
<p>Our website&#8217;s visitors can choose to contact us via form(s) on our website. In order to prevent spam enquiries, we protect our forms with anti-spam challenges which ensure the visitor is an actual living person, rather than a computer bot or spider.</li>
</ul>
<h2><a id="pp_seven"></a>Actual cookies deployed</h2>
...
<td>This cookie is set by our website once you have seen and acknowledged our Cookie banner. This cookie will expire and automatically delete itself after<strong> 1 </strong>month.</td>
</tr>
<tr>
...
<h2><a id="pp_eight"></a>How to disable cookies</h2>
...
<p>If you are concerned about cookies tracking your movements on the Internet then you may be concerned about spyware. Spyware is the name given to a particular band of cookies that track personal information about you. There are many antispyware programs that you can use to prevent this from happening. Learn more about antispyware software &#8211; <a title="Spyware" href="http://en.wikipedia.org/wiki/Spyware" target="_blank">http://en.wikipedia.org/wiki/Spyware. </a>You call also disable Google Analytics on all websites by downloading the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank">Google Analytics Opt-out Browser Add-on</a>.</p>
    </main>
    <!-- #main -->
    </div>
    </section>
